...
CREATE DATABASE IF NOT EXISTS e_procurement;
USE e_procurement;
...
CREATE TABLE IF NOT EXISTS suppliers (
  ...
  categories JSON,
  status ENUM('PENDING', 'APPROVED', 'REJECTED', 'SUSPENDED', 'BLACKLISTED') DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS supplier_documents (
  ...
  document_type ENUM('BUSINESS_LICENSE', 'TAX_CLEARANCE', 'REGISTRATION_CERT', 'TIN_CERT', 'VAT_CERT', 'EXPERIENCE_DOCS', 'FINANCIAL_STATEMENTS', 'OTHER') NOT NULL,
...
CREATE TABLE IF NOT EXISTS procurement_requests (
  ...
  status ENUM('DRAFT', 'PENDING_HOD', 'HOD_APPROVED', 'HOD_REJECTED', 'PENDING_PROCUREMENT', 'PROCUREMENT_APPROVED', 'PROCUREMENT_REJECTED', 'PENDING_FINANCE', 'FINANCE_APPROVED', 'FINANCE_REJECTED', 'APPROVED', 'TENDER_CREATED', 'CANCELLED') DEFAULT 'DRAFT',
...
CREATE TABLE IF NOT EXISTS tenders (
  ...
  procurement_method ENUM('OPEN', 'RESTRICTED', 'DIRECT', 'REQUEST_FOR_QUOTATION') DEFAULT 'OPEN',
  budget_estimate DECIMAL(15,2),
  currency VARCHAR(10) DEFAULT 'TZS',
  submission_deadline TIMESTAMP NOT NULL,
  opening_date TIMESTAMP NOT NULL,
  closing_date TIMESTAMP NOT NULL,
  status ENUM('DRAFT', 'PUBLISHED', 'CLOSED', 'UNDER_EVALUATION', 'AWARDED', 'CANCELLED') DEFAULT 'DRAFT',
...
CREATE TABLE IF NOT EXISTS bids (
  ...
  rank INT,
  status ENUM('SUBMITTED', 'UNDER_REVIEW', 'EVALUATED', 'AWARDED', 'REJECTED', 'DISQUALIFIED') DEFAULT 'SUBMITTED',
...
CREATE TABLE IF NOT EXISTS bid_documents (
  ...
  document_type ENUM('TECHNICAL_PROPOSAL', 'FINANCIAL_PROPOSAL', 'SUPPORTING_DOCUMENT') NOT NULL,
  document_name VARCHAR(255) NOT NULL,
  file_path VARCHAR(500) NOT NULL,
  file_size INT,
  mime_type VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS supplier_ratings (
  ...
  compliance_score INT NOT NULL CHECK (compliance_score BETWEEN 1 AND 5),
...
CREATE INDEX idx_procurement_requests_org ON procurement_requests(organization_id);
