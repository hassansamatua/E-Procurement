...
CREATE TABLE IF NOT EXISTS tenders (
  ...
  status VARCHAR(20) DEFAULT 'DRAFT' CHECK (status IN ('DRAFT', 'PUBLISHED', 'CLOSED', 'UNDER_EVALUATION', 'EVALUATION_COMPLETE', 'PENDING_AWARD_APPROVAL', 'AWARD_APPROVED', 'AWARDED', 'CANCELLED')),
