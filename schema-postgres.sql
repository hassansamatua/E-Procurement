...
CREATE TABLE IF NOT EXISTS procurement_requests (
  ...
  status VARCHAR(50) DEFAULT 'DRAFT' CHECK (status IN ('DRAFT', 'PENDING_HOD', 'HOD_APPROVED', 'HOD_REJECTED', 'PENDING_PROCUREMENT', 'PROCUREMENT_APPROVED', 'PROCUREMENT_REJECTED', 'PENDING_FINANCE', 'FINANCE_APPROVED', 'FINANCE_REJECTED', 'APPROVED', 'TENDER_CREATED', 'CANCELLED')),
